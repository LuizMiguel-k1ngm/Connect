...
<head>
    ...
    #thread-svg line {
        stroke: rgba(33, 41, 116, 0.14);
        stroke-width: 2;
    }

    #thread-svg .fill-line {
        stroke: #ff751f;
        stroke-width: 2;
    }
    ...
    .schedule-card:hover .s-desc {
        color: rgba(255, 255, 255, 0.7);
    }

    .schedule-card:hover .s-time {
        color: #ffa25c;
    }
...
<body class="bg-white">
    ...
    <header class="fixed top-0 inset-x-0 z-50 bg-navy-dark/70 backdrop-blur-lg border-b border-white/10">
        <nav class="max-w-6xl mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <ul class="hidden lg:flex items-center gap-9">
                <li><a href="#hero" class="text-white/80 hover:text-white text-sm font-medium transition">Início</a>
                </li>
                <li><a href="#horarios"
                        class="text-white/80 hover:text-white text-sm font-medium transition">Horários</a></li>
                <li><a href="#sobre" class="text-white/80 hover:text-white text-sm font-medium transition">Sobre</a>
                </li>
                <li><a href="#aovivo" class="text-white/80 hover:text-white text-sm font-medium transition">Ao vivo</a>
                </li>
                <li><a href="#local" class="text-white/80 hover:text-white text-sm font-medium transition">Local</a>
                </li>
            </ul>

            <a href="#aovivo"
                class="hidden lg:inline-flex items-center rounded-full bg-orange text-white font-semibold text-sm px-5 py-2.5 shadow-lg shadow-orange/30 hover:-translate-y-0.5 hover:shadow-xl transition">
                Assista ao vivo
            </a>
        ...
        <div id="mobileMenu"
            class="hidden lg:hidden bg-navy-dark border-t border-white/10 px-6 py-5 flex flex-col gap-4">
            ...
            <a href="#aovivo"
                class="inline-flex justify-center rounded-full bg-orange text-white font-semibold text-sm px-5 py-2.5 mt-2">Assista
                ao vivo</a>
        </div>
    </header>


    <section id="hero" data-node="Início"
        class="relative min-h-screen flex items-center pt-28 overflow-hidden bg-[radial-gradient(120%_100%_at_15%_0%,_#37409e_0%,_#212974_45%,_#12153f_100%)]">
        <canvas id="network-canvas"></canvas>

        <div class="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full">
            <div class="max-w-3xl">
                <div
                    class="inline-flex items-center gap-2.5 text-orange-light text-[13px] font-semibold uppercase tracking-widest mb-6">
                ...
                <p class="mt-7 max-w-lg text-lg text-white/70 leading-relaxed">
                    O Culto Connect existe pra ligar pessoas a Deus e umas às outras — presencial ou de onde você
                    estiver. Um lugar pra chegar como você é.
                </p>

                <div class="mt-10 flex flex-wrap gap-4">
                    <a href="#horarios"
                        class="inline-flex items-center gap-2 rounded-full bg-orange text-white font-semibold px-7 py-4 shadow-lg shadow-orange/30 hover:-translate-y-0.5 transition">
                        Ver horários dos cultos →
                    </a>
                    <a href="#aovivo"
                        class="inline-flex items-center gap-2 rounded-full border border-white/30 text-white font-semibold px-7 py-4 hover:bg-white/10 transition">
                        Assistir ao vivo
                    </a>
                </div>
    ...
    <section id="horarios" data-node="Horários" class="py-28 bg-cream">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div
                class="reveal grid md:grid-cols-4 border border-navy/10 rounded-2xl overflow-hidden divide-x divide-navy/10">
                <div class="schedule-card bg-white p-9">
                    <div class="s-day text-[13px] font-bold uppercase tracking-wider text-navy-light">Quarta · Noite
                    </div>
                    <div class="s-time font-display text-4xl font-bold text-navy my-3">19h30</div>
                    <div class="s-desc text-[#6a6e9c] text-sm leading-relaxed">PG dos Adolescentes, encontro marcado
                        toda quarta-feira do mês.</div>
                </div>
                <div class="schedule-card bg-white p-9">
                    <div class="s-day text-[13px] font-bold uppercase tracking-wider text-navy-light">Sexta · Noite
                    </div>
                    <div class="s-time font-display text-4xl font-bold text-navy my-3">19h30</div>
                    <div class="s-desc text-[#6a6e9c] text-sm leading-relaxed">PG dos Adolescentes, encontro marcado
                        toda sexta-feira do mês</div>
                </div>
                <div class="schedule-card bg-white p-9">
                    <div class="s-day text-[13px] font-bold uppercase tracking-wider text-navy-light">Domingo . Manhã
                    </div>
                    <div class="s-time font-display text-4xl font-bold text-navy my-3">08h30</div>
                    <div class="s-desc text-[#6a6e9c] text-sm leading-relaxed">Culto Connect, acontece todo segundo
                        domingo de cada mês</div>
                </div>
                <div class="schedule-card bg-white p-9">
                    <div class="s-day text-[13px] font-bold uppercase tracking-wider text-navy-light">Domingo · Noite
                    </div>
                    <div class="s-time font-display text-4xl font-bold text-navy my-3">19h30</div>
                    <div class="s-desc text-[#6a6e9c] text-sm leading-relaxed">Copa Connect, toda última sexta-feira de
                        cada mês</div>
                </div>
            </div>
    </section>
    ...
    <section id="sobre" class="py-28">
        <div class="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal">
                <p class="font-display font-semibold text-navy text-2xl leading-snug mb-5">Connect não é só nome — é a
                    proposta.</p>
                <p class="text-[#454877] text-[17px] leading-relaxed mb-5">
                    Acreditamos que fé não foi feita pra ser vivida sozinha. O Culto Connect nasceu pra ser ponte: entre
                    você e Deus, entre você e uma comunidade que te recebe sem julgamento e caminha junto na vida real.
                </p>
                <p class="text-[#454877] text-[17px] leading-relaxed">
                    Seja no templo, na célula da sua rua ou na transmissão ao vivo do seu quarto — o convite é o mesmo:
                ...
                <div class="grid grid-cols-2 gap-6 mt-9">
                    <div class="border-l-[3px] border-orange pl-4">
                        ...
                        <span class="text-[#6a6e9c] text-[13.5px] leading-relaxed">Cultos presenciais toda semana, com
                            espaço pra todas as idades.</span>
                    </div>
                    <div class="border-l-[3px] border-orange pl-4">
                    ...
                    <div class="border-l-[3px] border-orange pl-4">
                        ...
                        <span class="text-[#6a6e9c] text-[13.5px] leading-relaxed">Transmissão ao vivo pra quem está
                            longe ou de mudança.</span>
                    </div>
                    <div class="border-l-[3px] border-orange pl-4">
                        <b class="block font-display text-navy text-base">Cuidado</b>
                        <span class="text-[#6a6e9c] text-[13.5px] leading-relaxed">Aconselhamento e acompanhamento
                            pastoral próximo.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="aovivo" data-node="Ao vivo"
        class="relative overflow-hidden py-24 bg-gradient-to-br from-orange to-[#ff8c42]">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 flex flex-wrap items-center justify-between gap-10">
            <div>
                <h2
                    class="font-display font-bold text-white text-3xl sm:text-4xl lg:text-[42px] leading-tight max-w-lg">
                    Não pôde vir? A gente leva o culto até você.
                </h2>
                <p class="mt-4 text-white/85 max-w-md text-base">
                    Transmissão ao vivo todo domingo, com chat aberto pra você orar e interagir com a igreja em tempo
                    real.
                </p>
            </div>
            <a href="https://www.youtube.com/c/PIBEmSaracuruna"
                class="inline-flex items-center gap-2 rounded-full bg-white text-orange font-bold px-8 py-4 hover:-translate-y-0.5 transition whitespace-nowrap">
                ▶ Assistir agora
            </a>
        </div>
    </section>
    ...
    <section id="local" data-node="Local" class="py-28 bg-navy-dark">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="reveal max-w-xl mb-16">
                ...
                <h2 class="font-display font-bold text-white text-3xl sm:text-4xl lg:text-5xl leading-tight">Vem pra
                    perto.</h2>
                <p class="mt-4 text-white/60 text-lg leading-relaxed">Um endereço fácil de chegar e fácil de se sentir
                    em casa.</p>
            </div>
            ...
            <div class="reveal grid lg:grid-cols-2 gap-4">
                <div class="bg-navy rounded-2xl p-11">
                    ...
                    <div class="flex gap-4 py-4">
                        <div class="w-9 h-9 rounded-[10px] bg-orange/20 flex items-center justify-center shrink-0"><i
                                class="fa-solid fa-location-dot text-address"></i></div>
                        <div>
                            <b class="block text-white text-sm">Endereço</b>
                            <span class="text-white/55 text-[13.5px]">Av. Barão do Rio Branco 526 Saracuruna,
                                D.Caxias</span>
                        </div>
                    </div>
                    <div class="flex gap-4 py-4 border-t border-white/10">
                        <div class="w-9 h-9 rounded-[10px] bg-orange/20 flex items-center justify-center shrink-0"><i
                                class="fa-brands fa-whatsapp text-whatsapp"></i></div>
                        <div>
                    ...
                    <div class="flex gap-4 py-4 border-t border-white/10">
                        <div class="w-9 h-9 rounded-[10px] bg-orange/20 flex items-center justify-center shrink-0"><i
                                class="fa-solid fa-at text-white"></i></i></div>
                        <div>
                    ...
                    <div class="flex gap-4 py-4 border-t border-white/10">
                        <div class="w-9 h-9 rounded-[10px] bg-orange/20 flex items-center justify-center shrink-0"><i
                                class="fa-solid fa-car-side text-orange"></i></div>
                        <div>
                ...
                <div class="rounded-2xl overflow-hidden min-h-[340px] bg-navy-light relative"
                    style="background-image:radial-gradient(circle at 30% 30%, rgba(255,117,31,0.35), transparent 45%);">
                    <svg viewBox="0 0 300 340" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                        ...
                        <circle cx="150" cy="150" r="24" fill="none" stroke="#ff751f" stroke-opacity="0.5"
                            stroke-width="2" />
                        <circle cx="150" cy="150" r="42" fill="none" stroke="#ff751f" stroke-opacity="0.25"
                            stroke-width="2" />
                    </svg>
                </div>
            </div>
    ...
    <footer class="bg-navy-dark border-t border-white/10 pt-14 pb-9">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="flex flex-wrap justify-between items-start gap-8 pb-9 border-b border-white/10">
                <div>
                    <div class="font-display font-extrabold text-xl text-white">CULTO<span
                            class="text-orange">CONNECT</span></div>
                    <p class="text-white/50 text-sm mt-2 max-w-xs leading-relaxed">Fé que conecta pessoas — presencial
                        ou de onde você estiver.</p>
                </div>
                <div class="flex gap-3">
                    <a href="https://www.instagram.com/pib.saracuruna/" aria-label="Instagram"
                        class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-orange hover:border-orange transition"><i
                            class="fa-brands fa-instagram"></i></a>
                    <a href="https://www.youtube.com/c/PIBEmSaracuruna" aria-label="YouTube"
                        class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-orange hover:border-orange transition"><i
                            class="fa-brands fa-youtube"></i></a>
                    <a href="https://wa.me/qr/2LPDYD2TKORGP1" aria-label="WhatsApp"
                        class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-orange hover:border-orange transition"><i
